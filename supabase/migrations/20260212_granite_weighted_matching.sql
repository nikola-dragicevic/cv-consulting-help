...
-- Implements the Granite Architecture's scoring system:
-- Base Score: Vector similarity
-- Keyword Bonus: Specific keyword matches
-- Category Bonus: 20% multiplier for matching categories
...
-- Add comment
COMMENT ON FUNCTION match_jobs_granite IS 'Granite Architecture Layer 2: Weighted hybrid search with vector similarity, keyword matching, and category boosting';
