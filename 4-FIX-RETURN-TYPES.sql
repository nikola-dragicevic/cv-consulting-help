-- ========================================================================
-- FIX RETURN TYPES: id is TEXT, not BIGINT
-- ========================================================================
...
-- Success message
SELECT '✅ Function created with correct return types!' as status;

-- Quick count test
SELECT COUNT(*) as active_jobs_with_embeddings
FROM job_ads
